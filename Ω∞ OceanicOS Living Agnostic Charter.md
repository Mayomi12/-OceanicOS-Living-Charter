...
Where the two ever conflict on principle, the native Charter is the source of truth and this document is corrected to match. Where they differ only in *wording*, that is by design: this is the portable law.
...
3. Uncertainty is represented honestly, on a shared, declared scale (natively: `certain · high · medium · low · speculation`).
...
1. All knowledge moves through one pipeline. Agnostically:
   ...
   *(natively: Drops → Currents → Pools → Living Knowledge → Wisdom → Responsible Action → a Better Drop)*
